...
const i18nMessages = {
  zh: {
    ...
    aboutText2: '本软件由 BH1JSS 机婶婶贡献。网络版连接本地设备需要浏览器插件并有延迟，强烈建议使用本地版。',
  ...
  en: {
    ...
    aboutText2: 'Contributed by BH1JSS. Connecting local devices from the web version requires the browser plugin and may introduce latency. The desktop app is strongly recommended.',
